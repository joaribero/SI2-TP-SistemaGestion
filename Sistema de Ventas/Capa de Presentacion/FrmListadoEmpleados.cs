...
namespace Capa_de_Presentacion
{
    public partial class FrmListadoEmpleados : DevComponents.DotNetBar.Metro.MetroForm
    {
        ...
        {
            Program.IdEmpleado = Convert.ToInt32(dataGridView1.CurrentRow.Cells[0].Value);
            Program.ApelEmpleado = dataGridView1.CurrentRow.Cells[3].Value +"";
            Program.NomEmpleado = dataGridView1.CurrentRow.Cells[4].Value + "";
            if (Program.LlamadaExt == true)
                this.Close();
        }
    }
}
